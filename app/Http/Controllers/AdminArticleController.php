<?php namespace App\Http\Controllers;
	...
	class AdminArticleController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Is Html","name"=>"is_html"];
			...
			$this->form[] = ['label'=>'Is Html','name'=>'is_html','type'=>'radio','validation'=>'required|integer','width'=>'col-sm-10','dataenum'=>'true;false'];
			...
			//$this->form[] = ['label'=>'Content','name'=>'content','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			//$this->form[] = ['label'=>'Image','name'=>'image','type'=>'upload','validation'=>'image|max:3000','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			//$this->form[] = ['label'=>'Is Html','name'=>'is_html','type'=>'radio','validation'=>'required|integer','width'=>'col-sm-10','dataenum'=>'1;2'];
			# OLD END FORM
